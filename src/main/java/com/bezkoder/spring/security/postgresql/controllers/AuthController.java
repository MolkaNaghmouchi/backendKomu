...
public class AuthController {
  ...
  public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
    ...
    return ResponseEntity
        .ok(new JwtResponse(jwt,refreshToken, userDetails.getId(), userDetails.getUsername(), userDetails.getEmail(), roles ));
  }
 ...
 /* @PostMapping("/refresh-token")
  public void refreshToken(
    ...
    userRepository.refreshToken(request, response);
  }*/
  ...
  public ResponseEntity<?> refreshToken(HttpServletRequest request) {
    ...
    if (refreshToken != null && refreshToken.startsWith("Bearer ")) {
      ...
      if (jwtUtils.validateJwtToken(refreshToken)) {
        ...
        userRepository.refreshToken(username, refreshToken);
        ...
        return ResponseEntity.ok(new JwtResponse(newAccessToken, userDetails.getId(), userDetails.getUsername(), userDetails.getEmail(), userDetails.getAuthorities(), newRefreshToken));
      }
    }
